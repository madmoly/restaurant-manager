      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <Card className="p-5">
          ...
          <div className="space-y-3">
            ...
            <RoleRow label="점장 (manager)" count={u?.managers ?? 0} color="bg-emerald-500" total={u?.total ?? 1} />
            <RoleRow label="직원 (employee)" count={u?.employees ?? 0} color="bg-slate-500" total={u?.total ?? 1} />
          </div>
        </Card>
