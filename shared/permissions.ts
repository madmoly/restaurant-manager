 ...
 *
 * @example
 * getEffectiveRole("employee", "store_manager") // → "manager"
 * getEffectiveRole("employee", "employee")       // → "employee"
 * getEffectiveRole("admin", "employee")          // → "admin"
 * getEffectiveRole("manager", null)              // → "manager"
 */
 ...
 * 최소 역할 레벨 충족 여부 확인
 *
 * @param effectiveRole  getEffectiveRole()의 반환값
 * @param minRole        필요한 최소 역할
 */
